...
export const CountryComponent = () => {
  ...
  // ✅ Setear filtro SOLO cuando cambia la URL
  useEffect(() => {
    if (country) {
      dispatch({
  ...
  // 🔥 NO usar [0], buscar el país correcto
  const countryShow = state.countries?.find(
  ...
  return (
    <section className="main__country">
      <div className="country__btn">
        <button className="btn__back" onClick={handleClickBtnBack}>
