window.addEventListener("DOMContentLoaded", () => {
    ...
    const renderWinnerMessage = (winner, player, house) => {
        ...
        pickedPlayer.src = `../../frontend-mentor/frontend-mentor-09/assets/img/images/icon-${player}.svg`;
        pickedHouse.src = `../../frontend-mentor/frontend-mentor-09/assets/img/images/icon-${house}.svg`;
